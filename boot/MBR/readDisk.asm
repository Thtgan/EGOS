...
__real_readDisk:
    ...
    xor ebp, ebp
    mov bp, [si + 0x18] ;;Get size of single sector
    ...
    pop dword [si + 0x08] ;;Parameter in EAX (Index of first disk sector to read, pushed in line 16)

    mov dword [si + 0x0C], 0

    pop dx  ;;Recover drive number (Drive number, pushed in line 15)

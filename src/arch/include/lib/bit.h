...
#define BIT_SET_FLAG(__FLAGS, __FLAG)           (__FLAGS = BIT_OR(__FLAGS, __FLAG))
#define BIT_CLEAR_FLAG(__FLAGS, __FLAG)         (__FLAGS = BIT_AND(__FLAGS, BIT_NOT(__FLAG)))
#define BIT_REVERSE_FLAG(__FLAGS, __FLAG)       (__FLAGS = BIT_XOR(__FLAGS, __FLAG))
...
#define BIT_MASK(__FULL_LENGTH, __BEGIN, __END) BIT_LEFT_SHIFT(BIT_RIGHT_SHIFT(BIT_FULL_MASK(__FULL_LENGTH), __FULL_LENGTH - (__END - __BEGIN)), __BEGIN)

#define BIT_MASK8(__BEGIN, __END)               BIT_MASK(8, __BEGIN, __END)
#define BIT_MASK16(__BEGIN, __END)              BIT_MASK(16, __BEGIN, __END)
#define BIT_MASK32(__BEGIN, __END)              BIT_MASK(32, __BEGIN, __END)
#define BIT_MASK64(__BEGIN, __END)              BIT_MASK(64, __BEGIN, __END)

#define BIT_CUT(__VAL, __BEGIN, __END)          BIT_AND(__VAL, BIT_MASK(64, __BEGIN, __END))

...
#define ___RESCAN_DUMMY2(__ARG) MACRO_RESCAN(MACRO_RESCAN(MACRO_RESCAN(MACRO_RESCAN(__ARG))))

#define FOREACH_MACRO_CALL(__MACRO, __CONNECTOR, ...) __VA_OPT__(___RESCAN_DUMMY2(__FOREACH_MACRO_CALL_HELPER(__MACRO, __CONNECTOR, __VA_ARGS__)))
